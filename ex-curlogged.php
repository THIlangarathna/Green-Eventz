...
<body>
  ...
  <li><a href="mainexlogged.php"><h5 class="p"><center><img src="logo.png" style="height: 45px;width: 45px;"></center>Home</h5></a></li>
    <li><a href="co-curlogged.php"><h5 class="p"><center><img src="study.png" style="height: 45px;width: 45px;"></center>Co-Curricular</h5></a>
  </li>
    <li><a href="ex-curlogged.php" class="b"><h5 class="p"><center><img src="extra.png" style="height: 45px;width: 45px;"></center>Extra Curricular</h5></a>
  </li>
