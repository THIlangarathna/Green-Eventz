...
$query="select * from regevents1 where category='Kuppi' order by date";
...
<body>
  ...
  <li><a href="mainex.php"><h5 class="p"><center><img src="logo.png" style="height: 45px;width: 45px;"></center>Home</h5></a></li>
    ...
    <li><a href="kuppi.php"  class="b"><h5 class="p"><center><img src="kuppi.png" style="height: 45px;width: 45px;"></center>Kuppi</h5></a>
  </li>
