...
$query="select * from regevents1 where category='Extra-Curricular' order by date";
...
<body>
  ...
  <li><a href="mainex.php"><h5 class="p"><center><img src="logo.png" style="height: 45px;width: 45px;"></center>Home</h5></a></li>
    ...
    <li><a href="ex-cur.php" class="b"><h5 class="p"><center><img src="extra.png" style="height: 45px;width: 45px;"></center>Extra Curricular</h5></a>
  </li>
...
<div class="cards">
  ...
  ?>
</div></div></div></div></div></div></div></div></div></div></div></div></div></center>
