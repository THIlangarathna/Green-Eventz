...
<body>
  ...
  <li style="float: right"><a href="SignUp.php"><h5 class="p"><center><img src="signup.png" style="height: 45px;width: 45px;"></center>Try Again</h5></a></li>
</ul>
<h1 style="font-family: arial;
	...
	opacity: 0.9;
	padding-top: 15%;
	padding-bottom: 10%;">Sorry,Username is Already Taken :(</h1>
</center>
<div id="foot">
