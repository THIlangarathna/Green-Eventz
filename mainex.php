...
$query="select * from regevents1 order by date";
...
<body>
  ...
  <ul>
  <li><a href="mainex.php" class="b"><h5 class="p"><center><img src="logo.png" style="height: 45px;width: 45px;"></center>Home</h5></a></li>
    <li><a href="co-cur.php"><h5 class="p"><center><img src="study.png" style="height: 45px;width: 45px;"></center>Co-Curricular</h5></a>
  </li>
    <li><a href="ex-cur.php"><h5 class="p"><center><img src="extra.png" style="height: 45px;width: 45px;"></center>Extra Curricular</h5></a>
  </li>
    <li><a href="sports.php"><h5 class="p"><center><img src="sports.png" style="height: 45px;width: 45px;"></center>Sports</h5></a>
  </li>
    <li><a href="kuppi.php"><h5 class="p"><center><img src="kuppi.png" style="height: 45px;width: 45px;"></center>Kuppi</h5></a>
  </li>
